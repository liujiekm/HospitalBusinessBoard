<%@ Page Title="" Language="C#" MasterPageFile="~/Content.Master" AutoEventWireup="true" CodeBehind="SpecialInspection.aspx.cs" Inherits="WYYY.HDGM.Web.SpecialInspection" %>
...
<%--    <script src="content/bootstrapdatepicker/bootstrap-datetimepicker.js"></script>
    ...
    <script src="content/js/jquery/rome.js"></script>
    <style type="text/css">
        .chart {
            width: 100%;
            padding: 20px;
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            rome(dtp_input1, { time: false });
            rome(dtp_input2, { time: false });
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_reportContent" runat="server">
    ...
    <div class="row" style="padding-left:15px;padding-right: 15px;padding-top:5px;">
        ...
        <div class="col-md-4">
            ...
            <input type ="text" class="form-control" id="dtp_input1" />
        ...
        <div class="col-md-4 ">
            ...
            <input type ="text" class="form-control" id="dtp_input2" />
