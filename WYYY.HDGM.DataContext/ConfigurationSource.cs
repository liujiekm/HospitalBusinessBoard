...
namespace WYYY.HDGM.DataContext
{
    public class ConfigurationSource
    {
        ...
        private static DatabaseSettings GenerateDatabaseSettings()
        {
            ...
            settings.ProviderMappings.Add(new DbProviderMapping("Oracle.DataAccess.Client", "WYYY.HDGM.DataContext.OracleDatabase, WYYY.HDGM.DataContext, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null"));
            return settings;
        }
